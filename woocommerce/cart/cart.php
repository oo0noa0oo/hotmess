 ...
 * Cart Page
 *
 * Hot Sauce Co custom cart template
        ...
        <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th class="product-price-main"><?php esc_html_e( 'Price', 'woocommerce' ); ?></th>
            ...
            <tbody>
                        ...
                        <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                            ...
                            <td class="product-name" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
                                <div class="product-name-wrapper">
                                    ...
                                    <!-- Display Heat Level and Scoville for cart items -->
                                    <?php if ( $heat_level || $scoville ) : ?>
                                        <div class="cart-item-meta">
                                            <?php if ( $heat_level ) : ?>
                                                <span class="heat-badge heat-<?php echo esc_attr( $heat_level ); ?>">
                                                    <?php echo esc_html( ucfirst( $heat_level ) ); ?> Heat
                                                </span>
                                            <?php endif; ?>
                                            ...
                                            <?php /*
                                                ...
                                                <span class="scoville-rating">
                                                    <?php echo esc_html( number_format( $scoville ) ); ?> SHU
                                                </span>
                                            <?php endif; */?>
                                        </div>
                                    <?php endif; ?>
                            ...
                            <td class="product-price-main" data-title="<?php esc_attr_e( 'Price', 'woocommerce' ); ?>">
                                <?php
							...
							<td class="product-remove">
                                ...
                                echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                    ...
                                    sprintf(
                                        '<a href="%s" class="remove mini-cart-remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="fas fa-times"></i></a>',
                ...
                <tr>
                    <td class="ucart" colspan="6" class="actions">
